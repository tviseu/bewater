...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const PRODUTOS_PERMITIDOS = {
      ...
      'PROTEIN_WAFER_001': { nome: 'Protein Wafer', preco: 2.00 },
      'ALL_PEANUTS_BAR_001': { nome: 'All Peanuts Bar', preco: 1.60 },
      'PROTEIN_GOURMET_BAR_001': { nome: 'Protein Gourmet Bar', preco: 2.50 },
      ...
      // Eventos
      'EVENTO_MARIOBOMBA_20260214': { nome: 'Workshop Mario Bomba - Inscrição Externa', preco: 15.00 },

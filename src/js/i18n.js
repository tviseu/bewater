...
const translations = {
    ...
    'pricing.starter.feature3': 'A mensalidade do primeiro mês é cobrada apenas a partir da data em que começas a treinar',
      ...
      'schedule.legend.jiujitsu': 'Jiu‑Jitsu com e sem kimono: GI (tradicional, pegadas e controlo de pano) e NO GI (dinâmico, foco em alavancas e controlo sem pano).',
      ...
      'faq.answer.1': '<strong>Treino funcional Be Water</strong>, <strong>treinos express Lone Warrior</strong>, <strong>Jiu-Jitsu</strong>, <strong>Boxe</strong>, <strong>Muay Thai</strong> e acesso <strong>open gym</strong> em três zonas (estúdio, dojo e lounge).',
    ...
    en: {
      ...
      'schedule.legend.jiujitsu': 'Jiu‑Jitsu with and without kimono: GI (traditional, grip and cloth control) and NO GI (dynamic, leverage and control without cloth).',
      ...
      'faq.answer.1': '<strong>Be Water functional training</strong>, <strong>Lone Warrior express workouts</strong>, <strong>Jiu-Jitsu</strong>, <strong>Boxing</strong>, <strong>Muay Thai</strong> and <strong>open gym</strong> access in three zones (studio, dojo and lounge).',

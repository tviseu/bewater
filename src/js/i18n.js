...
const translations = {
    pt: {
      ...
      'faq.answer.4': '<strong>Taxa única de inscrição (+ seguro anual): 25 €.</strong><br><br>Três planos mensais <strong>sem fidelização</strong>:<br><br><strong>Elite – 94,90 €/mês</strong> (uso ilimitado)<br><strong>Rise – 79,90 €/mês</strong> (3×/semana)<br><strong>Starter – 64,90 €/mês</strong> (2×/semana)',
      ...
      'faq.question.6': 'Preciso de acompanhamento individual?',
      'faq.answer.6': 'Temos vários <strong>Personal Trainers (PTs)</strong>. Se te interessar, fala com qualquer membro da equipa Be Water para agendar <strong>sessões one-on-one</strong>.',
      'faq.question.7': 'Exemplo prático de custos',
      'faq.answer.7': 'Plano Rise (79,90 €/mês), início a 15 de agosto (17 dias por treinar num mês de 31):<br><br>Inscrição + seguro: 25 €<br>Mensalidade proporcional: 79,90 € × 17/31 ≈ 43,82 €<br><strong>Total no dia da inscrição: 68,82 €.</strong><br><br>No dia 1 de setembro passa a ser debitado o valor completo de 79,90 €',
      ...
      'faq.answer.12': '<strong>Sim</strong>, temos <strong>estacionamento gratuito</strong> para membros. <strong>Lugares limitados</strong>.',
    ...
    en: {
      ...
      'faq.answer.4': '<strong>One-time registration fee (+ annual insurance): 25 €.</strong><br><br>Three monthly plans <strong>without commitment</strong>:<br><br><strong>Elite – 94,90 €/month</strong> (unlimited use)<br><strong>Rise – 79,90 €/month</strong> (3×/week)<br><strong>Starter – 64,90 €/month</strong> (2×/week)',
      ...
      'faq.question.6': 'Do I need individual coaching?',
      'faq.answer.6': 'We have several <strong>Personal Trainers (PTs)</strong>. If you\'re interested, talk to any Be Water team member to schedule <strong>one-on-one sessions</strong>.',
      'faq.question.7': 'Practical cost example',
      'faq.answer.7': 'Rise plan (79,90 €/month), starting August 15th (17 days to train in a 31-day month):<br><br>Registration + insurance: 25 €<br>Proportional monthly fee: 79,90 € × 17/31 ≈ 43,82 €<br><strong>Total on registration day: 68,82 €.</strong><br><br>On September 1st, the full amount of 79,90 € will be charged',
      ...
      'faq.answer.12': '<strong>Yes</strong>, we have <strong>free parking</strong> for members. <strong>Limited spaces</strong>.',
